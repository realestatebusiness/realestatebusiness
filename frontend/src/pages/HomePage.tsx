...
export const HomePage = () => {
  ...
  const propertyTypes =
    selectedTab === "Plots/Land" ? plotTypes : residentialTypes;
      ...
      <div className="bg-white rounded-xl shadow-md p-6 mt-6 max-w-7xl mx-auto mb-8">
        ...
        <div className="flex flex-wrap items-center gap-4 mt-6 border border-gray-300 rounded-lg px-4 py-4 bg-white">
          ...
          <div className="flex gap-2">
            <div
              className="p-2 rounded-full bg-blue-50 text-blue-600 cursor-pointer hover:bg-blue-100 transition"
              onClick={() => {
                navigator.geolocation.getCurrentPosition((position) => {
                  ...
                  console.log(
                    "Navigating to:",
                    `/propertiesnearme?lat=${latitude}&lng=${longitude}`
                  );
          ...
          <div className="mt-5">
            ...
            {activeFilter === "Sharing" && (
              <div className="w-full border border-gray-200 rounded-xl p-5 mt-4 shadow-sm bg-white">
                ...
                <div className="flex flex-wrap gap-3">
                  {["Private Rooms", "2 Per Room", "2+ Per Room"].map(
                    (sharing) => (
                      <button
                        key={sharing}
                        onClick={() =>
            ...
            <div key={property._id} className="mb-6">
              <div className="text-sm text-gray-600 mb-2">
                ...
                <span className="font-medium text-gray-800">
                  ...
                  {property.basicDetails?.propertyType || "N/A"})
                </span>
              </div>
              ...
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center bg-gray-50 p-4 rounded-lg border border-gray-200">
                <div className="flex items-center gap-4">
                  <div className="w-20 h-20 bg-gray-200 rounded-md flex items-center justify-center">
                    <img
                      src={
                        property.media?.[0]?.url || "/placeholder-building.png"
                      }
                      alt="Property"
                  ...
                  <div>
                    ...
                    <h3 className="text-base font-semibold text-gray-900">
                      {property.basicDetails?.propertyTitle ||
                        "Untitled Property"}
                    </h3>
                    <p className="text-sm text-gray-600">
                      in {property.locationDetails?.locality || "N/A"},{" "}
